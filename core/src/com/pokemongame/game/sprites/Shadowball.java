...
public class Shadowball {
    ...
    public Shadowball(float x, float y){
        damage = 20;
        position = new Vector2(x, y);
        velocity = new Vector2(0, -170);
        texture = new Texture("shadowball_spritesheet.png");
        currentAnimation = new Animation(new TextureRegion(texture),  5, 1, 5, 0.7f);

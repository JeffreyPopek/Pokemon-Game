...
public class Mewtwo {
    ...
    public Mewtwo(int x, int y) {
        ...
        texture = new Texture("mewtwo_spritesheet.png");
        currentAnimation = new Animation(new TextureRegion(texture), 125, 5, 25, 3.5f);
    ...
    public void attack() {
        ...
        texture = new Texture("mewtwo_spritesheet.png");
        this.currentAnimation = new Animation(new TextureRegion(texture), 125, 5, 25, cycleTime);
        ...
        timer.scheduleTask(new Timer.Task() {
            ...
            public void run() {
                ...
                texture = new Texture("mewtwo_spritesheet.png");
                currentAnimation = new Animation(new TextureRegion(texture), 125, 5, 25, 3.2f);
                busy = false;
            }
        }, cycleTime);
